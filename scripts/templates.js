        ...
        <div class="overlay-content ${pokemon.types[0]}" onclick="event.stopPropagation()">
            ...
            <div class="card-overlay-details">
                ...
                <div class="tab-pokemon-overlay">
                    <button class="tab_links" onclick="openTabOverlay(event,'Main')">Main</button>
                    <button class="tab_links active" onclick="openTabOverlay(event, 'Stats')">Stats</button>
                </div>
                <div id="Main" class="tab_content margin-top" style="display: none;">
                ...
                <div id="Stats" class="tab_content" style="display: block;">
...
function getMorePokemonsTemplate() {
    return `
    <div id="loadMorePokemons" onclick="loadMorePokemons()" class="more-pokemons-btn">Load<br>5 more<br>Pokémons</div>
    `
}